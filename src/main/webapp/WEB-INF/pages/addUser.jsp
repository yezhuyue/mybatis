...
<div class="container">
    ...
    <form:form action="${pageContext.request.contextPath}/addUserPost" method="post" commandName="user" >
        <div class="form-group">
            <label for="inputId" class="col-sm-2 control-label" >Id</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputId" name="id" placeholder="请输入Id">
            </div>
        </div>
        <div class="form-group">
            <label for="inputName" class="col-sm-2 control-label">Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputName" name="name" placeholder="请输入用户名">
            </div>
        </div>
        <div class="form-group">
