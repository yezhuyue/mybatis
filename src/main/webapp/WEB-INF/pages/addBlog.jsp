...
<div class="container">
    ...
    <form:form action="${pageContext.request.contextPath}/addBlogPost" method="post" commandName="blog">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="inputTextarea" name="content" rows="3" placeholder="请输入内容..."></textarea>
        </div>
        <div class="form-group">
